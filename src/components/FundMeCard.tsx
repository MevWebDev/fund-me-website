...
export function FundMeCard() {
  ...
  if (!isConnected) {
    return (
      <div className="w-full max-w-md bg-black/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 text-center flex flex-col items-center justify-center min-h-[400px] space-y-6 shadow-2xl">
